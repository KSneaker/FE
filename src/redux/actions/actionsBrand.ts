...
export const getAllBrands = async (accessToken: string, dispatch: any) => {
    try {
...
export const postBrand = async (accessToken: string, dispatch: any, body: any) => {
    try {
...
export const updateBrand = async (accessToken: string, dispatch: any, body: any) => {
    try {
